...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td bgcolor="#F9C21F" align="center">
            <!--[if (gte mso 9)|(IE)]>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding">
                                    <p>
                                        Dear {{$mailingModel->name}}
                                        <br><br>
                                        Mimic ICO starts in <b>{{$day}}</b> day(s). Don't miss it! :)
                                    </p>
                                </td>
                            </tr>
    ...
    <tr>
        <td bgcolor="#F9C21F" align="center" style="padding: 20px 0px;">
            <!--[if (gte mso 9)|(IE)]>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="500">
            <tr>
            <td align="center" valign="top" width="500">
