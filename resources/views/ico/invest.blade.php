...
@section('javascript')
    <script>
        ...
        function calculateInvestment() {
            ...
            var number_of_eth_to_pay = $("#number_of_eth_to_pay");
            var dataToSend = {
                ...
                number_of_eth_to_pay: number_of_eth_to_pay.val(),
            };
            ...
            calculateInvestmentTimer = setTimeout(function() {   
                ...
                if(number_of_eth_to_pay.val()) {
                    number_of_eth_to_pay.val(parseFloat(number_of_eth_to_pay.val()).toFixed(5));
                }
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR) {
                        ...
                        if(data.amount_to_send_to_other_account == 0 || data.amount_to_send_to_other_account == null) {
                            msg+= "You'll get <b>"+data.number_of_mim+"</b> MimiCoins<br>You need to pay <b>"+dataToSend.number_of_eth_to_pay+"</b> ETH"; 
                            showInfo(msg, true);
                        } else {
                            msg+= "You'll get <b>"+data.number_of_mim+"</b> MimiCoins<br>You need to pay <b>"+dataToSend.number_of_eth_to_pay+"</b> ETH"; 
                            showInfo(msg, true);
        ...
        $("#invest-form").submit(function(e) {
            ...
            //validate
            if (data['first_name'] == '' || data['last_name'] == '' || data['email'] == '' || data['investor_account_number'] == '') {
