...
<body>
    ...
    <div class="container-fluid height-100" id="content">
        <div class="row height-100" id="container-left">
            ...
            <div class="cols-xs-12 col-sm-12 col-md-6 Aligner height-100" id="container-middle">
                <div class="Aligner-center">
                    <div class="slider one-time">
                        ...
                        <div class="text-center">
                            ...
                            <img src="{{$mimic->file_url}}" class="mimic-img-video">
                        </div>
                        @else
                    ...
                    <div class="slider one-time">
                        ...
                        @foreach ($mimic->responses as $response) 
                            ...
                            <div class="text-center">
                                ...
                                <img src="{{$response->file_url}}" class="mimic-img-video">
